                ...
                <div class="row breadcrumbs-top d-inline-block">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Detail Group - <span id="id-product-group" data-id="<?=$detailGroup->group_product_id?>"><?=$detailGroup->group_product_name?></span>
                            </li>
                        </ol>
                    </div>
                </div>
...
<div class="modal fade text-left" id="add-new-group" role="dialog" aria-labelledby="myModalLabel17" data-backdrop="static" data-keyboard="false"
     aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body" id="dataTableGroupSearchProduct">
                <img src="<?= BASE_URL ?>public/images/cdn/empty_state.png" alt="" id="img-search-product-group" class="img-fluid" style="display: block;margin: auto">
            </div>
        ...
        if($("#data-id-"+idProduct).data("click")==="off"){
            ...
            $.post("<?=BASE_URL?>products/add-product-group-handle", {
                ...
                if(tempAdd.message === "OK"){
                    ...
                    toastr.success('Thành công!', 'Thêm '+$("#data-id-"+idProduct).text()+" thành công.",{"showMethod": "slideDown", "hideMethod": "slideUp", timeOut: 1000});
                }else {
                    toastr.error('Thất bại!', 'Thêm '+$("#data-id-"+idProduct).text()+" thất bại.",{"showMethod": "slideDown", "hideMethod": "slideUp", timeOut: 1000});
                }
            })
        }else {
            $.post("<?=BASE_URL?>products/delete-product-group-handle", {
                ...
                if(tempAdd.message === "OK"){
                    ...
                    toastr.warning('Thành công!', 'Xóa '+$("#data-id-"+idProduct).text()+" thành công.",{"showMethod": "slideDown", "hideMethod": "slideUp", timeOut: 1000});
                }else {
                    toastr.error('Thất bại!', 'Thêm '+$("#data-id-"+idProduct).text()+" thất bại.",{"showMethod": "slideDown", "hideMethod": "slideUp", timeOut: 1000});
                }
            })
